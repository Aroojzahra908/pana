        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              {/* Email Field */}
              <div>
                <label htmlFor="admin-email" className="mb-1 block text-sm text-gray-700">
                  Email
                </label>
                <input
                  id="admin-email"
              ...
              <div className="relative">
                <label htmlFor="admin-pass" className="mb-1 block text-sm text-gray-700">
                  Password
                </label>
                <input
                  id="admin-pass"
                  type={showPassword ? "text" : "password"}
                  className="w-full rounded-lg border border-gray-300 px-3 py-2 pr-10 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-[rgba(0,180,187,0.5)]"
