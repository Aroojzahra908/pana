...
const Home = () => {
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      category: "Machine Learning",
      description: "AI-powered diagnostic system improving patient outcomes",
      image: "/tech-icons/image.png",
      metrics: ["99.2% accuracy", "50% faster diagnosis", "Enhanced patient care"],
      clientLogo: "/tech-icons/image.png"
    },
    {
      title: "Intelligent Supply Chain",
      category: "AI Automation",
  ...
  const processSteps = [
  {
    ...
    title: "Discovery",
    description: "We analyze your business needs and identify AI opportunities",
    image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=600&h=400&fit=crop&crop=center&q=80",
    color: "from-sky-400 to-sky-600",
    icon: "🔍"
  },
  {
  ...
  },
  {
    ...
    title: "Development",
    description: "Build and train custom AI models using best practices",
    image: "https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=600&h=400&fit=crop&crop=center&q=80",
    color: "from-slate-400 to-slate-600",
    icon: "⚙️"
  },
  {
